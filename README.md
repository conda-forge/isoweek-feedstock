...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/isoweek-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12159&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/isoweek-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `isoweek` can be installed with:

```
conda install isoweek
```

It is possible to list all of the versions of `isoweek` available on your platform with:
